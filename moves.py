...
# posation is passed in and returned with the stickers in the order they should be after the turn.

# Front Quarter Turn Cposkwise
def F(pos):
...
# Front Quarter Turn Countercposkwise
def Fp(pos):
...
# Right Quarter Turn Countercposkwise
def Rp(pos):
...
# Up Quarter Turn Countercposkwise
def Up(pos):
